...
export class EngagementPricingService {
  private static buffered: EngagementMetrics | null = null;
  private static flushTimer: ReturnType<typeof setTimeout> | null = null;

  private static scheduleFlush(metrics: EngagementMetrics) {
    this.buffered = metrics;
    if (this.flushTimer) {
      return;
    }
    this.flushTimer = setTimeout(async () => {
      try {
        if (this.buffered) {
          await this.saveEngagementMetrics(this.buffered);
        }
      } finally {
