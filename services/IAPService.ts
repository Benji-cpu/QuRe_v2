...
export class IAPService {
  ...
  static async initialize(): Promise<void> {
    ...
    try {
      ...
      if (__DEV__) console.log('IAP initialized successfully');
  ...
  static async fetchProducts(): Promise<void> {
    ...
    try {
      ...
      if (__DEV__) console.log('Products fetched:', this.products.length);
    } catch (error) {
  ...
  static async restorePurchases(): Promise<Purchase[]> {
    ...
    try {
      ...
      if (__DEV__) console.log('Restored purchases:', purchases.length);
  ...
  static async purchaseProduct(
    ...
    try {
      ...
      this.purchaseUpdateSubscription = purchaseUpdatedListener(async (purchase: Purchase) => {
        if (__DEV__) console.log('Purchase successful:', purchase);
